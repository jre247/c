...
import DestinationCreate from './DestinationCreate.js';
...
class Index extends Component {
  ...
  render() {
    ...
    return (
      <DestinationCreate {...destinationCreateProps} />
    );
